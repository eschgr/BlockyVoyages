#if !defined(__DESERT_BIOME_H__)
#define __DESERT_BIOME_H__
...
public:
    ...
    // across the biome
    BlockType GetSurfaceType(const Vector2f& pos) const { return kSand; }
    ...
    BlockType GetPrimarySurfaceType() const { return kSand; }
